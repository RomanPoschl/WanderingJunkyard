...
public class ShipMesh
{
    ...
    public void Rotate(ShipMeshVertex[] vertices, Vector3 center, Quat quaterion)
    {
        foreach (var vert in vertices)
        {
            var centered = vert.Coordinates - center;
            vert.Coordinates = quaterion.Xform(vert.Coordinates) + center;
        }
    }
    ...
    public void Scale(Vector3 scaleVector, Matrix4x4 faceSpace, ShipMeshVertex[] vertices)
    {
