...
public class TravelLane
{
    public Vector2 Position { get; set; }
    public Vector2 Destination { get; set; }
}

public class SectorGenerator : Node2D
{
    ...
    public void Generate()
    {
        ...
        var mainStar = _star.Instance<CellestialObject>();
        ...
        for(var a = 0; a < 10; a++)
        {
            var planet = _planet.Instance<CellestialObject>();
            ...
            {
                var moon = _moon.Instance<CellestialObject>();
